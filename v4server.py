...
class AuctionServerGUI:
    ...
    def build_ui(self):
        ...
        Button(self.root, text="Start Auction",
               command=self.start_auction).pack(pady=5)

        Button(self.root, text="Pause",
               command=self.toggle_pause).pack(pady=5)
